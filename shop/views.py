...
def searchMatch(query, item):
    ...
    if query in item.descrip.lower() or query in item.product_name.lower() or query in item.category.lower():
        return True
    else:
        return False
...
def contact(request):
    ...
    if request.method == "POST":
        ...
        contact = Contact(name=name, email=email, phone=phone, descrip=descrip)
        contact.save()
        thank = True
